 ...
 */
public class ContainerSecretEnvVar extends AbstractContainerEnvVar {

    private String secretName;
    private String secretKey;

    @DataBoundConstructor
    public ContainerSecretEnvVar(String key, String secretName, String secretKey) {
        this.key = key;
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        ContainerSecretEnvVar other = (ContainerSecretEnvVar) obj;
        if (key == null) {
            if (other.key != null)
                return false;
